...
#ifdef WXTOOLBOX_EXPORTS
#define WXTOOLBOX_API __declspec(dllexport)
#else
#define WXTOOLBOX_API __declspec(dllimport)
#endif
#else
#define WXTOOLBOX_API
#endif
...
class WXTOOLBOX_API wxToolObject
{
protected:
...
class WXTOOLBOX_API wxToolBoxItem : public wxToolObject
{
protected:
	wxWindowID m_ID;
	/// Parent component
...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxToolBoxItem, wxToolBoxItemArray, WXTOOLBOX_API);

// ========================================================================
//  wxToolBoxTab
// ------------------------------------------------------------------------
///	Contains information about toolbox tab, including array of toolbox items
class WXTOOLBOX_API wxToolBoxTab : public wxToolBoxItem
{	
protected:
...
WX_DECLARE_USER_EXPORTED_LIST(wxToolBoxTab, wxToolBoxTabList, WXTOOLBOX_API);

// ========================================================================
//  wxToolItemEditorTextCtrl
// ------------------------------------------------------------------------
///	Text area for entering new labels of toolbox tabs and items
class WXTOOLBOX_API wxToolItemEditorTextCtrl : public wxTextCtrl
{
...
class WXTOOLBOX_API wxToolBoxScrollButton : public wxToolObject
{
...
class WXTOOLBOX_API wxToolBoxBitmapSet
{
protected:
...
class WXTOOLBOX_API wxToolObjectBackground
{
	/// Normal background
...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxBitmap, wxToolBoxIconArray, WXTOOLBOX_API);
...
*/
class WXTOOLBOX_API wxToolBox : public wxControl
{		
...
*/
class WXTOOLBOX_API wxToolBoxEvent : public wxCommandEvent
{
	wxToolBoxTab * m_Tab;
	wxToolBoxItem * m_Item;
...
BEGIN_DECLARE_EVENT_TYPES()
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_TAB_ADDED, 13666)
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_TAB_SELECTED, 13667)
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_TAB_DELETED, 13678)
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_TABS_SWAPPED, 13669)
		/// Not implemented
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_TAB_MOVED, 13670)

	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_ITEM_ADDED, 13671)
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_ITEM_SELECTED, 13672)
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_ITEM_DELETED, 13673)		
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_ITEMS_SWAPPED, 13674)
	/// Not implemented
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_ITEM_MOVED, 13675)

	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_SKIN_LOADED, 13676)
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_SKIN_SAVED, 13677)

	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_STRUCTURE_LOADED, 13678)
	DECLARE_EXPORTED_EVENT_TYPE(WXTOOLBOX_API, wxEVT_TB_STRUCTURE_SAVED, 13679)
